...
Public Class frmAddEditBlockCode
...
#Region "Database"
    ...
    Private Function AddNew() As Boolean
        ...
        Dim strSQL As String = "INSERT INTO sectionblockcodes " _
            & "(Term,SchoolYear,BlockName,EncodedBy) VALUES " _
            & "(?Term,?SchoolYear,?BlockName,?EncodedBy)"
        ...
        Try
            Using myconn As New MySqlConnection(ConnectionString)
                Using mycommand As New MySqlCommand
                    ...
                    mycommand.Parameters.AddWithValue("BlockName", Me.txtSubjectCode.Text)
                    mycommand.Parameters.AddWithValue("EncodedBy", CurrentSystemUser)
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If Me.IsAdding = True Then
            If Me.AddNew = True Then
                MessageBox.Show("Done adding new block code.", "Add block code.", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Me.MustUpdate = True
        ...
        Else
            If Me.ModifyDepartment = True Then
                MessageBox.Show("Done updating block code.", "Modify block code.", MessageBoxButtons.OK, MessageBoxIcon.Information)
                Me.MustUpdate = True
                Me.CurrentSearchString = Me.txtDescriptiveTitle.Text
                Me.Close()
            Else
