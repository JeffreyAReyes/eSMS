...
Public Class frmAddEditCourseOfferingsByBlock
...
#Region "Properties"
    ...
    Dim strCurrentBlockCode As String
    Public Property CurrentBlockCode() As String
        Get
            Return strCurrentBlockCode
        End Get
        Set(ByVal value As String)
            strCurrentBlockCode = value
        End Set
    End Property
#End Region
