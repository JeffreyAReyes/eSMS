...
#Region "Database"
    ...
    Public Function GetEnrollmentDetails(ByVal strEDP As String, ByVal strTerm As String, ByVal strYear As String) As Boolean

        Dim boolResult As Boolean
        Dim dtaTable As New DataSet

        Try
            dtaTable = GetDataAndReturnDataSetByTermYearByEDP(ConnectionString, "GetEnrollmentDetailsAndLedger", 4, strTerm, strYear, strEDP)
            ...
            'get student ledger
            For Each rowsub As DataRow In dtaTable.Tables(5).Rows

                With Me.dvgLedger
                    .Rows.Add(rowsub("SLID"), rowsub("StudentID"), rowsub("TransDate"), rowsub("RefNum"), rowsub("Debit"), _
                              rowsub("Credit"), rowsub("LedgBalance"), rowsub("Remarks") & " / " & rowsub("RefNum"))
                End With
            Next
    ...
    Private Sub GetSemestralFees(ByVal strTerm As String, ByVal strCurrentYear As String)

        'Dim dtatable As New DataTable

        TheTableOfFees = GetDataAndReturnDataTableByTermYear(ConnectionString, "GetSemestralFees", 4, strTerm, strCurrentYear)
    ...
    Private Function SaveStudentEnrollment(ByVal boolIsAdding As Boolean) As Boolean
        ...
        Dim strModifyEnrolledStudentsSQL As String = "DELETE FROM enrolledstudentssubjects WHERE " _
            ...
            & "IsRegistered=1,EnrolYear=?EnrolYear " _
            ...
            Using myconn As New MySqlConnection(ConnectionString)
                ...
                Try
                    Using mycommandmain As New MySqlCommand
                        ...
                        mycommandmain.Parameters.AddWithValue("Term", Me.cboTerm.Text)
                        mycommandmain.Parameters.AddWithValue("SchoolYear", Me.cboSchoolYear.Text)
                    ...
                    Using mycommanddetails As New MySqlCommand
                        ...
                        With mycommanddetails
                            ...
                            Term.Value = Me.cboTerm.Text
                            SchoolYear.Value = Me.cboSchoolYear.Text
                    ...
                    Using mycommandassessment As New MySqlCommand
                        ...
                        mycommandassessment.Parameters.AddWithValue("Term", Me.cboTerm.Text)
                        mycommandassessment.Parameters.AddWithValue("SchoolYear", Me.cboSchoolYear.Text)
                    ...
                    Using mycommandledger As New MySqlCommand
                        ...
                        mycommandledger.Parameters.AddWithValue("Term", Me.cboTerm.Text)
                        mycommandledger.Parameters.AddWithValue("SchoolYear", Me.cboSchoolYear.Text)
                        mycommandledger.Parameters.AddWithValue("TransDate", Me.dtpEnrolled.Value.Date)
...
#Region "Helper"
    ...
    Private Sub PrintText(ByVal sender As Object, ByVal ev As PrintPageEventArgs)
        ...
        ev.Graphics.DrawString("Student Dev't    : ", New Font("Draft PS", 10.0!, FontStyle.Regular), Brushes.Black, CSng(550.0!), CSng(115.0!))
        ev.Graphics.DrawString(FormatNumber(0, 2), New Font("Draft PS", 10.0!, FontStyle.Regular), Brushes.Black, 750.0!, 115.0!, format)
        ...
        ev.Graphics.DrawString("Lab. Fee         : ", New Font("Draft PS", 10.0!, FontStyle.Regular), Brushes.Black, CSng(550.0!), CSng(130.0!))
        ev.Graphics.DrawString(FormatNumber(decLabFee, 2), New Font("Draft PS", 10.0!, FontStyle.Regular), Brushes.Black, 750.0!, 130.0!, format)
        ...
        ev.Graphics.DrawString("Misc. Fee         : ", New Font("Draft PS", 10.0!, FontStyle.Regular), Brushes.Black, CSng(550.0!), CSng(145.0!))
        ev.Graphics.DrawString(FormatNumber(decMiscFee, 2), New Font("Draft PS", 10.0!, FontStyle.Regular), Brushes.Black, 750.0!, 145.0!, format)
        ...
        ev.Graphics.DrawString("Less: Payments   : ", New Font("Draft PS", 10.0!, FontStyle.Regular), Brushes.Black, CSng(550.0!), CSng(240.0!))
        ev.Graphics.DrawString(FormatNumber(decLess, 2), New Font("Draft PS", 10.0!, FontStyle.Regular), Brushes.Black, 750.0!, 240.0!, format)
        ev.Graphics.DrawString("--------------", New Font("Draft PS", 10.0!, FontStyle.Regular), Brushes.Black, 750.0!, 250.0!, format)
        ev.Graphics.DrawString("*Balance         : ", New Font("Draft PS", 10.0!, FontStyle.Regular), Brushes.Black, CSng(550.0!), CSng(265.0!))
        ev.Graphics.DrawString(FormatNumber(decBalance, 2), New Font("Draft PS", 10.0!, FontStyle.Regular), Brushes.Black, 750.0!, 265.0!, format)
        ...
        num2 = (num2 + 20)
        ev.Graphics.DrawString(("** Total Units : " & Me.lblTotUnits.Text & " **"), New Font("Draft PS", 9.0!, FontStyle.Regular), Brushes.Black, 80.0!, CSng(num2))
        num2 = (num2 + 10)
...
#End Region
    ...
    Private Sub frmAddEditStudentEvaluation_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Me.ToolStripStatusLabel1.Text = SetWindowHeader(Me, "Student Ledger")
        InitializeFeesGrids()
        GetSemestralFees(Me.cboTerm.Text, Me.cboSchoolYear.Text)
        GetCourseOfferings()
    ...
    Private Sub txtEDP_KeyUp(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles txtEDP.KeyUp
        Select Case e.KeyCode
            Case Keys.Enter
                ClearControls()
                GetSemestralFees(Me.cboTerm.Text, Me.cboSchoolYear.Text)
                If GetEnrollmentDetails(Me.txtEDP.Text, Me.cboTerm.Text, Me.cboSchoolYear.Text) = True Then
                    Me.txtYear.Focus()
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        ...
        If Me.SaveStudentEnrollment(False) = True Then
            'Me.PrintCertificate()
