...
#Region "Properties"
    ...
    Dim strCurrentDeptCode As String
    Public Property CurrentDeptCode() As String
        Get
            Return strCurrentDeptCode
        End Get
        Set(ByVal value As String)
            strCurrentDeptCode = value
        End Set
    End Property
    ...
    Dim strCurrentDeptName As String
    Public Property CurrentDeptName() As String
        Get
            Return strCurrentDeptName
        End Get
        Set(ByVal value As String)
            strCurrentDeptName = value
        End Set
    End Property
...
#Region "Helper"
    ...
    Public Function VerifyData() As Boolean
        ...
        If Me.cboDept.SelectedIndex < 0 Then
            Me.cboDept.Focus()
            Me.ErrProve.SetError(Me.cboDept, "Please select department from the list.")
            VerifyData = False
            Exit Function
        End If

        If Me.cboDept.SelectedValue.ToString.ToUpper <> CurrentUserDept.ToUpper Then
            Me.cboDept.Focus()
            Me.ErrProve.SetError(Me.cboDept, "Please select the department your login name is assigned.")
            VerifyData = False
            Exit Function
        End If
...
#End Region
    ...
    Private Sub cmdSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSave.Click
        If Me.VerifyData = False Then
            'MessageBox.Show(Me.VerifyData)
            Exit Sub
        End If

        With Me
            .IsOk = True
            .CurrentDeptName = Me.cboDept.Text
            .Close()
        End With
    End Sub
